...
const BLOG = {
  ...
  AUTHOR: 'ow24th', // 您的昵称 例如 tangly1024
  BIO: 'welcome to the world of luxury', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ow24th.com', // 网站地址
  KEYWORDS: 'hermes, ow24th,chanel', // 网站关键词 英文逗号隔开
